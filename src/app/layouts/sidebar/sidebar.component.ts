...
import { MENU, AUTHOR_MENU, EXAMINER_MENU, ANALYTICS_MENU, MODERATOR_MENU, SHARED_MENU } from './menu';
...
export class SidebarComponent implements OnInit {
  ...
  constructor(private router: Router, public translate: TranslateService, private user: UserService) {
