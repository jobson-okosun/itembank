...
@Component({
  selector: 'app-rejected-questions-list',
  templateUrl: './rejected-questions-list.component.html',
  styleUrls: ['./rejected-questions-list.component.scss'],
})
export class RejectedQuestionsListComponent implements OnInit {
  @Input() status: string;
