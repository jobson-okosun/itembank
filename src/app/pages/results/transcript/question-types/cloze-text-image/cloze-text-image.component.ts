...
@Component({
  selector: 'app-cloze-text-image',
  templateUrl: './cloze-text-image.component.html',
  styleUrls: ['./cloze-text-image.component.scss']
})
export class ClozeTextImageComponent implements OnInit {
